$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/java/features/featureParameters.feature");
formatter.feature({
  "line": 1,
